    ...
    <section>
        <div>
            <ul>
                ...
                <li>
                    <RouterLink to="/adicionar-grupo" class="link">
                        Adicionar Grupo de Estudo
                    </RouterLink>
                </li>
                <li>
                    <RouterLink to="/adicionar-nucleo" class="link">
                        Adicionar Núcleo
                    </RouterLink>
                </li>
                <li>
                    <RouterLink to="/adicionar-comite" class="link">
                        Adicionar Comite
                    </RouterLink>
                </li>
                <li>
                    <RouterLink to="/adicionar-comissao" class="link">
                        Adicionar Comissao
                    </RouterLink>
                </li>
                <li>
                    <RouterLink to="/adicionar-venda" class="link">
                        Adicionar Venda
                    </RouterLink>
                </li>
                <li>
    ...
    <section>
        ...
        <div v-if="mostrarCampoSenha">
            ...
            <div class="campo-senha">
                <input :type="senhaVisivel ? 'text' : 'password'" id="senha" v-model="form.senha" placeholder="Informe sua nova senha">
