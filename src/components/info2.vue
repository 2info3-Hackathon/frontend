...
<template>
    ...
    <ul>
      <li v-for="produto in info2" :key="produto.id">
        ...
        <p v-for="preco in info2" :key="preco.id"></p>
        <p class="preco"> R${{ produto.preco }}</p>

        <p v-for="local in info2" :key="local.id"></p>
...
section.info2 div p.nome {
  margin: 0 0 0.2vw 0;
  font-family: bold;
  font-size: 1.6vw;
}
section.info2 div p.local {
  font-family: bold;
  font-size: 1.4vw;
}
section.info2 div p.preco {
  font-family: bold;
  font-size: 1.2vw;
}
section.info2 div button.comprar {
  font-size: 1vw;
  font-weight: bold;
  color: white;
  margin: 0.6vw 0 0 0;
